          ...
          return Column(
            ...
            children: [
              if (showExecution) ...[
                ...
                const SizedBox(height: 6),
                Text(
                  "Położenie hydroizolacji: ${robocizna.toStringAsFixed(2)} zł",
                  style: const TextStyle(fontSize: 16, color: Colors.black),
                ),
                if (tasksCost > 0)
                  Text(
                    "Prace dodatkowe: ${tasksCost.toStringAsFixed(2)} zł",
                    style: const TextStyle(fontSize: 16, color: Colors.black),
                  ),
                if (travelCost > 0)
                  Text(
                    "Dojazd ${km.toStringAsFixed(0)}km: ${travelCost.toStringAsFixed(2)} zł",
                    style: const TextStyle(fontSize: 16, color: Colors.black),
                  ),
                if (execRabat > 0)
                  Text(
                    ...
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text('VAT 23%',
                            style: pw.TextStyle(font: arial, fontSize: 9)),
                             pw.SizedBox(height: 3),
                        pw.Text('Koszt materiałów: ${sumaPoRabacie.toStringAsFixed(2)} zł brutto',
                ...
                if (showExecution) ...[
                  ...
                  children: [
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text('VAT 23%',
                            style: pw.TextStyle(font: arial, fontSize: 9)),
                             pw.SizedBox(height: 3),
                         pw.Text(
                        'Kosz wykonania: ${execAfterDiscount.toStringAsFixed(2)} zł brutto',
                        style: pw.TextStyle(font: arialBold, fontSize: 10, color: PdfColors.black),
                      ),
                      ],
                    )
                      ...
                      if (__labelsRest.isNotEmpty) pw.Padding(padding: const pw.EdgeInsets.only(top: 2), child: pw.Text('Ciąg dalszy zakresu na kolejnej stronie →', style: pw.TextStyle(font: arial, fontSize: 9, color: PdfColors.grey700))),
                      pw.SizedBox(height: 8),
                      pw.Divider(color: PdfColors.orange),
                      pw.Text(
                        'Razem do zapłaty: ${grandTotal.toStringAsFixed(2)} zł brutto',
